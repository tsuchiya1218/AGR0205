...
<body>
    ...
    <main>
        ...
        <a href="delayUnsent.php" class="btn btn--orange btn--cubic btn--shadow">未送信リスト</a>
        ...
        <table border="1" width="830">
            ...
            if (count($records) > 0) {
                ...
                foreach ($records as $row) {
                    ...
                    <td style=\"padding: 20px;\"><a href=delayDetail.php?ID=$row[a_Num]>$row[a_Name]</a></td>
