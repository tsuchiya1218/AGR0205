...
<body>
    ...
    <main>
        ...
        WHERE \"check\"=0 AND DOC.stateNum !=5
        ";
//SQL文を実行
...
$row = $stmt->fetchAll(PDO::FETCH_BOTH);
        ...
        <a href="reserveList.php" class="btn btn--orange btn--cubic btn--shadow">全件表示</a>
        <?php
                if(empty($row)){
                    echo "<br>予約はありません<br>";
                }else{?>
        ...
        <a href="index.html" class="btn btn--orange btn--cubic btn--shadow">ホームに戻る</a>
        <a href="reserveManage.html" class="btn btn--orange btn--cubic btn--shadow">予約管理に戻る</a>
