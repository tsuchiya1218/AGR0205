...
<body>
    <main>
        ...
        <?php if(!empty($_SESSION['e'])){
            echo '<p style="color:red;">フリガナが一致しません</p>';
            $_SESSION['e']=null;
        }?>
        <form action="chenge.php"> 
            フリガナ：<input type="text" name="name" id="">
            <br>
            <br>
            もう一回入力してください<input type="text" name="nameR" id="">
            <br><br>
            <input id="" name="chenge" type="hidden" value="a_Furigana">
